...
export function FormSection({ data }: { data: SectionData; sharedByName?: string | null }) {
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="mt-10 flex flex-col gap-3 max-w-sm mx-auto">
            ...
            <p className="mt-4 text-[11px] text-lp-grey/80 text-center font-medium leading-relaxed font-body">
              Prefer to just talk? Call Deana anytime:{" "}
              <a
                href="tel:+19724000017"
                className="text-lp-gold hover:underline underline-offset-2 transition-colors font-semibold"
              >
                (972) 400-0017
              </a>
            </p>
