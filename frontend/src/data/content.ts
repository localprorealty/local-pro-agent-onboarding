...
export const SECTIONS = [
  ...
  },
  {
    ...
    body: "Every brokerage hands you a stack of resources — a CRM login, a marketing portal, a training calendar — and calls it support. But nobody actually assembles it into a business for you. That's still on you: picking which tool fits which job, chasing down a photographer, remembering to follow up with a past client six months later, guessing whether any of it moved the needle. None of this shows up as one obvious task. It shows up as a hundred small ones, every week, quietly eating the hours you could spend with clients.",
    items: [
      { label: "FIND", detail: "Every new tool means another decision — which CRM feature, which template, which vendor to call." },
      { label: "COORDINATE", detail: "Marketing, photography, signage, paperwork — somebody has to chase all of it and keep it moving." },
      { label: "REMEMBER", detail: "The best follow-ups come from remembering a client's roof is 12 years old, or their kid just started college. Nobody hands you that memory." },
  ...
  },
  {
    ...
    body: "Every brokerage will tell you they have technology, marketing, training, and support. At LocalPRO, the difference isn't that we have those things — it's that we built them to work together, instead of five separate logins you juggle yourself. This part's easiest to just show you. Type a real address below and watch what normally takes an hour of manual entry happen in seconds.",
  ...
  },
  {
    ...
    body: "Every listing needs a description, a caption, maybe a flyer — and writing good copy from scratch, every single time, is its own quiet time sink. This is where the platform becomes a real collaborator: give it a few details, mention anything special about the property, and it drafts a genuine starting point in seconds. You're not handing off your judgment — you're skipping the blank page.",
    demo: "ai-marketing",
  },
  {
    id: "extension-demo",
    ...
    body: "Getting a listing onto MLS means retyping the same details you already entered above into an entirely separate, old-fashioned form. Our Chrome extension bridges that gap — it reads what you've already told the platform and fills the MLS form for you, field by field. You review it, you hit submit. That's the whole job.",
    demo: "extension-fill",
  },
  {
    id: "google-capture",
    ...
    body: "Entirely optional — sign in if you'd like us to follow up as you decide. Skip it and keep exploring; the form at the end covers this either way.",
    optional: true,
  },
  {
    ...
    body: "Performance First is the name for everything you've just scrolled through — the platform, the marketing help, the coaching, the accountability — all pointed at one outcome: helping you produce more, consistently, without burning out doing everything by hand. It's not a slogan. It's the actual operating philosophy behind what LocalPRO builds for its agents.",
  ...
  },
  {
    ...
    body: "The numbers below are illustrative — the real rate table is still being finalized with ownership — but the mechanics are real. Slide things around and see roughly what sponsoring a few productive agents could mean for your business over a year.",
  ...
  },
  {
    ...
    body: "If you believe your business is capable of more than it is today, we'd genuinely welcome a conversation.",
